// SuspendInjectResume.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
int main(int argc, char* argv)
{
	...
	scanf_s("%u", &pid);
	puts("Method used to attach thread is : SuspendInjectResume");
	DWORD dwProcessId = (DWORD)pid;
	// const char* dll = "C:\\v.dll";
	PCWSTR pszLibFile = L"C:\\DLLTest.dll";
#ifndef _WIN64
	DWORD a = demoSuspendInjectResume(pszLibFile, dwProcessId);
#else
	DWORD a = demoSuspendInjectResume64(pszLibFile, dwProcessId);
#endif
